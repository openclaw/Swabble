...
:root{
  ...
  --paper:#ffffff;
  --accent:#0f8f86;
  --accent-soft:rgba(15,143,134,.10);
  --accent-strong:#0a6f68;
  --pulse:#ff6b57;--pulse-soft:#f7c873;--wave:#22c7b8;--wave-deep:#0f8f86;
  --line:#e5e7eb;
  --line-soft:#eef0f3;
  --code-bg:#0f172a;
  --code-fg:#e6edf3;
...
:root[data-theme="dark"]{
  ...
  --paper:#171a23;
  --accent:#39d4c6;
  --accent-soft:rgba(57,212,198,.16);
  --accent-strong:#75eee4;
  --line:#262a36;
  --line-soft:#1d2029;
  --code-bg:#06080d;
  --code-fg:#e6edf3;
...
.brand .mark{display:flex;align-items:center;justify-content:center;gap:3px;flex:0 0 32px;width:32px;height:32px;border-radius:9px;background:linear-gradient(135deg,var(--wave),var(--accent));box-shadow:inset 0 0 0 1px rgba(255,255,255,.24)}
.brand .mark i{display:block;width:3px;border-radius:99px;background:#fff}
.brand .mark i:nth-child(1){height:9px;opacity:.78}
.brand .mark i:nth-child(2){height:18px}
.brand .mark i:nth-child(3){height:13px;opacity:.9}
.brand .mark i:nth-child(4){height:22px;background:var(--pulse-soft)}
...
export function faviconSvg() {
  return `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" role="img" aria-label="swabble">
<rect width="64" height="64" rx="16" fill="#0f1115"/>
<rect x="12" y="12" width="40" height="40" rx="12" fill="url(#g)"/>
<path d="M21 34c0 6.1 4.9 11 11 11s11-4.9 11-11" fill="none" stroke="#fff" stroke-width="4" stroke-linecap="round"/>
<rect x="28" y="17" width="8" height="20" rx="4" fill="#fff"/>
<path d="M32 45v7M25 52h14" stroke="#f7c873" stroke-width="4" stroke-linecap="round"/>
<defs><linearGradient id="g" x1="13" x2="51" y1="12" y2="52"><stop stop-color="#22c7b8"/><stop offset="1" stop-color="#0f8f86"/></linearGradient></defs>
</svg>`;
}
